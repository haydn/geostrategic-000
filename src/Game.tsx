...
const Game = ({
  ...
  }, [actions, selectedUnit, supabaseClient, units]);
              ...
              {units
                ...
                .map((unit) => {
                  ...
                  return (
                    <Token
                      key={unit.id}
                      x={transformX(left(unit.position))}
                      y={transformY(top(unit.position))}
                      width={
                        transformX(right(unit.position)) -
                        transformX(left(unit.position))
                      }
                      height={
                        transformY(bottom(unit.position)) -
                        transformY(top(unit.position))
                      }
